	...
	public partial class BugReportDialog : Form
	{
		...
		private void okButton_Click(object sender, EventArgs e)
		{
			...
			try
			{
				...
				{
					if (MessageBox.Show(this, "Bug report submitted successfully!\n\nWould you like to go to the bug page?", "SonLVL Bug Report", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == System.Windows.Forms.DialogResult.Yes)
						System.Diagnostics.Process.Start("http://mm.reimuhakurei.net/?page=bugs&id=" + sr.ReadLine());
				}
				else
				{
					MessageBox.Show(this, "Bug report failed!\n\n" + sr.ReadToEnd(), "SonLVL Bug Report Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
				}
				sr.Close();
				rs.Close();
			}
